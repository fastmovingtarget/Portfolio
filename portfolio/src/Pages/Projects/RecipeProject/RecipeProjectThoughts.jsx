    ...
    return (
        <div>
            ...
            <div>
                ...
                <div className="hoverable">
                    <h3>Weaknesses that I realised during development that I had to work on:</h3>
                    <ul>
                ...
                <div>
                    <h3>Development Timeline:</h3>
                        <ul>
                            ...
                            <h4>"Polishing" the basic product</h4>
                            <div className="hoverable">
                                <ul>
                            ...
                            <h4>Adding the Recipe Planner and Shopping List</h4>
                            <div className="hoverable">
                                <ul>
                            ...
                            <h4>Migrating to cached data</h4>
                            <div className="hoverable">
                                <ul>
                            ...
                            <div className="hoverable">
                                <ul>
                                    <li>After implementing and testing the new Context solution, I was once again able to submit the application to testing and received a much more significant spreadsheet in response. Some key takeaways for me:
                                        <ul>
                            ...
                            <div className="hoverable">
                                <ul>
                                    ...
                                    <p>Given the challenges involved in these, I'd prefer to build up my expertise in my other projects before moving back to work on it. For the moment my development on the Recipes Project will be confined to improving the existing
                                    functionality and visual polish rather than adding features.</p>
                                </ul>
                            </div>
                        </ul>
                    </div>
                    ...
                    <ul>
                        <li>What I've learned:
                            <ul>
                                ...
                                <li>I never did figure out a snappy name for it. Something so minor and yet so major...
                                </li>
                            </ul>
                        </li>
                    </ul>
