function Unemployment() {
    return (
        <div>
            <h3  name="unemployment">Voluntary Unemployment</h3>
            <p id="unemployment" >
                ...
                <br/>
                <br/>
                Following this project, I chose to focus on my personal improvement and mental and physical health. Working full time with a 2h commute had taken a toll upon my health, and my first priority was to improve my fitness and 
